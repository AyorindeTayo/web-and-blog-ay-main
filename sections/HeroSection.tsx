...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        PASSIONATE PROGRAMMER Machine Learnign Engineer(MLOPS)
      </span>
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label="yo Olanipekun character illustration levitating with a Macbook"
              alt="Ayo Olanipekun character illustration"
            />
          </div>
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a Machine Learning Engineer and Data Scientist with a passion for delivering
            exceptional results.
          </p>
          <p>
            With my expertise in building machine learning models,exploratory data analysis, building back and front end for machine learning applications, continuous integration and development CI/CD of machine learning models using the following tools Python, JavaScript, SQL, Matlab, React, TensorFlow, Dockers, Flask, Heroku, Streamlit, AWS, GCP, Azure, Git, Spark, GitHub Actions, Keras, scikit‑learn, Google BigQuery,NextJS, 
            Vscode,Vercel, Jenkins, Node.js, Fivetran, Gitlab, Jira, Kubeflow, CI/CD, Linux
