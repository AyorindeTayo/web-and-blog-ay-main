        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              With more than 5 years of comprehensive experience in machine learning research and data science.
              Specialized in Data Science, software developement, Research, Machine Learning its application to Engineering and real-life problems. I have built predictive models using machine learning algorithms that have helped solve business problems in the area of Finance, Digital marketing, Research, and Agriculture
            </p>
...
const educationInfo = [
  {
    id: 1,
    title: "PhD in Machine Learning Application to compuational Materials",
    subTitle: "University of Johannesburg| 2018 ~ 2021",
    list: [
      "Data Science",
